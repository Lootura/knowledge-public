...
### El DAO dice que a Marlaska le parece «injusta» su imputación y critica la «vanidad» de la UCO

El Director Adjunto Operativo (DAO) de la Guardia Civil, el teniente general Manuel Llamas, ha asegurado este viernes en la comisión Koldo del Senado que.

Date: 2026-07-17

### Discovered by Atlas

Manuel Llamas first entered the public knowledge record with source-backed evidence.
...
Nunca antes en la historia de la Guardia Civil un general de división había presentado una denuncia contra un teniente general. Se trata de un caso paradigmático en un cuerpo de naturaleza militar que arrastra el descrédito de haber visto al director adjunto operativo (DAO), Manuel Llamas, ordenar a la Unidad Central O.
